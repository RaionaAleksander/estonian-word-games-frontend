...
@Component({
  selector: 'app-game-settings-container',
  imports: [CollapsibleHeaderComponent, AllowIncompleteSectionComponent, WordsCountSectionComponent, GridSizeSectionComponent],
  templateUrl: './game-settings-container.component.html',
  styleUrl: './game-settings-container.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class GameSettingsContainerComponent extends ExpandableContainerDirective {
