...
import { CustomShapedWordSearchMainPanelComponent } from '../../components/custom-shaped-word-search-main-panel/custom-shaped-word-search-main-panel.component';
...
@Component({
  ...
  imports: [
    ...
    CustomShapedWordSearchMainPanelComponent,
...
export class ShapedWordSearchCustomPageComponent {
  ...
  protected query: CustomShapedWordSearchQuery = {
    settings: {
      rows: 10,
      cols: 10,
      blockedCells: [
  ...
  private generateGame(): void {
    ...
    this.api
      .generateCustomShapedGame(this.query)
      .subscribe({
        next: (res) => {
